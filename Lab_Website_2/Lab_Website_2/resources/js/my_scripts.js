var isStudent = document.getElementById("undergrad_select");
...
function viewStudentStats(id, toggle){
	//if yes is pressed display table
	var isStudent = document.getElementById(id);
	if(toggle==1){
		//document.getElementById(id)=isStudent
		isStudent.style.visibility="visible";
		isStudent.style.height="auto";
		console.log("Blah");
	}
	//if no takes away table
	if(toggle==0){
		isStudent.style.visibility="hidden";
		isStudent.style.height="0";
	}
...
function playerPlayers(playerNum){
